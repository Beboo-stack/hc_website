  ...
  const floors = [
    {
      ...
      shops: [
        ...
        { name: 'TIFFANY LIGHTING', category: 'Lighting', location: 'Top-right', logo: '/logos/logo-FB.webp' },
        { name: 'APEX 1948', category: 'Modern Furniture', location: 'Bottom-left', logo: '/logos/APEX-logo(1)-1.webp' },
        { name: 'ESQUE', category: 'Modern Furniture', location: 'Bottom-center', logo: '/logos/Esque_Artboard 1.webp' },
        { name: 'DROBINA', category: 'Kitchens Hardware', location: 'Bottom-right', logo: '/logos/vevian final logo white background.webp' },
        { name: 'INFORMATION DESK', category: 'Services', location: 'Center', logo: null }
      ]
    },
    {
      id: 'first',
      ...
      shops: [
        ...
        { name: 'RAIF', category: 'Fabrics / Curtains', location: 'Left', logo: '/logos/Raif Tex_Artboard 1.webp' },
        { name: 'The LumberJack', category: 'Outdoor', location: 'Left', logo: '/logos/Lumberjack-logo_vector.webp' },
        { name: 'cube furniture', category: 'Modern Furniture', location: 'Left', logo: '/logos/Cube.webp' },
        { name: 'FAGOR', category: 'Appliances', location: 'Top', logo: '/logos/fagor copy.webp' },
        { name: 'COMFORT', category: 'Mattresses', location: 'Top', logo: '/logos/Comfort Home collection (2).webp' },
        { name: 'RADWAN MARDINI', category: 'Fabrics / Curtains', location: 'Top', logo: '/logos/RADWAN-Mardini-NEW.webp' },
        { name: 'ARTYNOVA', category: 'Kitchens', location: 'Center-left', logo: '/38.jpg' },
        { name: 'Comfort Sleep', category: 'Mattresses', location: 'Center-left', logo: '/logos/Comfort-Sleep-Logo.webp' },
        { name: 'MALEK', category: 'Bed Linen', location: 'Center-left', logo: '/logos/Malek-New-Logo-2.webp' },
        { name: 'Kian', category: 'Outdoor', location: 'Center-right', logo: '/logos/kian-logo.webp' },
        { name: 'Asia FURNITURE', category: 'Outdoor', location: 'Center-right', logo: '/logos/Asia-copy.webp' },
        { name: 'DIVANO', category: 'Modern Furniture', location: 'Right', logo: '/logos/Divano_Artboard 1.webp' },
        { name: 'HANIMEX', category: 'Multiple Categories', location: 'Right', logo: '/logos/Hanimex_logo_black.webp' },
        { name: 'VELOUR DE GENE', category: 'Fabrics / Curtains', location: 'Bottom', logo: '/logos/velour-de-jene-logo-FINAL--2.webp' },
        { name: 'SPRING AIR', category: 'Mattresses', location: 'Bottom', logo: '/logos/spring-copy.webp' },
        { name: 'T Track', category: 'Doors & Windows', location: 'Bottom', logo: '/logos/T-Track.webp' },
        { name: 'Naguib Selim', category: 'Fabrics / Curtains', location: 'Bottom', logo: '/25.jpg' }
      ]
    },
    {
      id: 'second',
      ...
      shops: [
        ...
        { name: 'DOOR TECH EGYPT', category: 'Doors & Windows', location: 'Left', logo: '/logos/Doortech-New-Logo-2023-3.webp' },
        { name: 'NATUZZI EDITIONS', category: 'Modern Furniture', location: 'Left', logo: '/logos/Natuzzi-Edition.webp' },
        { name: 'FIDA HOME', category: 'Modern Furniture', location: 'Left', logo: '/logos/Fida-Home-Gte-Vinyl.webp' },
        { name: 'FURNITURE BEYOUT', category: 'Modern Furniture', location: 'Top', logo: null },
        { name: 'HANIMEX', category: 'Multiple Categories', location: 'Right', logo: '/logos/Hanimex_logo_black.webp' },
        { name: 'AL F ITALIA', category: 'Modern Furniture', location: 'Center', logo: '/logos/Alf-Italia.webp' },
        { name: 'Bed Home', category: 'Bed Linen', location: 'Bottom', logo: '/logos/Artboard 1 copy.webp' },
        { name: 'Smart Shutter', category: 'Doors & Windows', location: 'Bottom', logo: '/logos/SMART-Shutter-Final-Logo-copy.webp' },
        { name: 'MAINNOVA', category: 'Modern Furniture', location: 'Bottom', logo: '/logos/innova-logo--2.webp' }
      ]
    }
  ];
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-lg p-6 shadow-sm">
              <h3 className="text-lg font-semibold text-gray-900 mb-3">Information Desk</h3>
              <p className="text-gray-600">Located on the ground floor for assistance and directions.</p>
            </div>
            <div className="bg-white rounded-lg p-6 shadow-sm">
              <h3 className="text-lg font-semibold text-gray-900 mb-3">Restrooms (W.C.)</h3>
              <p className="text-gray-600">Available on all floors for your convenience.</p>
            </div>
            <div className="bg-white rounded-lg p-6 shadow-sm">
              <h3 className="text-lg font-semibold text-gray-900 mb-3">Exits</h3>
              <p className="text-gray-600">Multiple exits located throughout the mall for easy access.</p>
            </div>
          </div>
        </div>
      </section>
