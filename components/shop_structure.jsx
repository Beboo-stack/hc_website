      ...
      <div className="container mx-auto px-6 py-8">
          ...
          <div className="lg:col-span-2">
            <div className="bg-black/20 backdrop-blur-sm p-8 rounded-lg text-white">
              <p className="text-lg leading-relaxed">
                HC Furniture Mall hosts over 55 premium furniture and home decor
                stores under one roof. From luxury living room sets to
                functional kitchens, cozy bedrooms, and stylish accessories —
                there's something for every style and budget. The shops feature
                both international and local brands, offering a wide variety of
                products and price points. Whether you're furnishing a new home
                or upgrading a single room, HC is your all-in-one destination.
              </p>
            </div>
          </div>
            ...
            <div className="bg-black/30 backdrop-blur-sm w-full lg:w-fit p-6 rounded-lg text-white text-center lg:text-left">
              ...
              {data.phone && data.phone.length > 0 ? (
                data.phone.map((phoneNumber, index) => (
                  <div
                    className="flex items-center justify-center lg:justify-start space-x-3 mb-2"
                    key={index}
                  >
        ...
        {data.images && data.images.length > 0 && (
          <div className="mt-16">
            ...
            <ImageGallery images={data.images} height="h-[300px]" />
          </div>
        )}
      </div>
    </div>
