    ...
    <div className="py-[2px] w-full h-[100vh] md:h-[75vh] relative">
      ...
      <div className="absolute top-0 left-0 w-full h-full bg-black/50 flex flex-col items-start justify-end text-white px-5 pb-10">
        ...
        <div className="flex flex-col gap-3 md:flex-row w-full">
          <button className=" px-6 py-2 w-full md:w-fit border-2 border-gray-400 text-sm hover:bg-black hover:text-white transition duration-300" onClick={() => {router.push("/floor-plan")}}>
            Explore More
          </button>
